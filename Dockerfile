...
COPY lgtoclnt-8.2.4.11-1.x86_64.rpm lgtoserv-8.2.4.11-1.x86_64.rpm lgtonode-8.2.4.11-1.x86_64.rpm /
...
RUN yum localinstall --nogpgcheck -y /lgtoclnt-8.2.4.11-1.x86_64.rpm \
        /lgtoserv-8.2.4.11-1.x86_64.rpm /lgtonode-8.2.4.11-1.x86_64.rpm
